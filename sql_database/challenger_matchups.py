...
class ChallengerMatchup(Base):
    ...
    player1_name = Column(String(16))
    player1_champion = Column(String(25))
    ...
    player1_perks = Column(String(34))  # store as delimited string
    player1_role = Column(String(10))
    player2_name = Column(String(16))
    player2_champion = Column(String(25))
    ...
    player2_perks = Column(String(34))  # store as delimited string
    player2_role = Column(String(10))


    __table_args__ = (UniqueConstraint(
        'player1_name', 'player1_champion', 'player1_kills', 'player1_deaths', 'player1_assists',
        'player1_items', 'player1_perks', 'player1_role', 'player2_name', 'player2_champion', 'player2_kills',
        'player2_deaths', 'player2_assists', 'player2_items', 'player2_perks', 'player2_role', name='unique_matchup'),)

    def __init__(self, player1_name, player1_champion, player1_kills, player1_deaths, player1_assists, player1_items, player1_perks, player1_role, player2_name, player2_champion, player2_kills, player2_deaths, player2_assists, player2_items, player2_perks, player2_role):
        ...
        self.player1_perks = player1_perks
        ...
        self.player2_perks = player2_perks
